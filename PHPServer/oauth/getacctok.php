...
$request_token='CfZY3GSnJzkBian7fm6A4DPkfR2N5ApDdjzE10A76k';
$request_token_secret='jFzCKjrhVrMnWevAOw5yCDLdH8dM0104UcPTXc9Yo';
$oauth_verifier= '1450527';

echo $request_token . ", " . $request_token_secret . ", " . $oauth_verifier;
